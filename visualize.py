...
def create_visualizations(csv_file="results.csv", output_dir="plots"):
    ...
    # 1. Ranking Quality (NDCG@20 and Recall@20)
    ...
    plt.ylabel("Score")
    plt.ylim(0.8, 1.0) # Zoom in closely since all scores are naturally high
    ...
    # 2. Hardware Efficiency: Peak VRAM
    ...
    # 3. Hardware Efficiency: Epoch Training Time
    plt.figure(figsize=(8, 6))
